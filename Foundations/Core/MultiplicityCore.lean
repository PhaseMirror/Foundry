...
namespace Foundations.Core.MultiplicityCore
...
| base (i : Interaction Idx) : MultiplicityTerm Idx
| add (t₁ t₂ : MultiplicityTerm Idx) : MultiplicityTerm Idx
...
end Foundations.Core.MultiplicityCore
