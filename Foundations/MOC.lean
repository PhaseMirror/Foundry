...
def transition_108_cycle : OperatorWord baseVerified := 
  { ops := [
      Operator.subdivision ⟨3, -- TODO: replace sorry⟩ 3,
      Operator.subdivision ⟨3, -- TODO: replace sorry⟩ 3,
      Operator.subdivision ⟨3, -- TODO: replace sorry⟩ 3,
      Operator.subdivision ⟨2, -- TODO: replace sorry⟩ 2,
      Operator.subdivision ⟨2, -- TODO: replace sorry⟩ 2
    ] 
  }
...
theorem transition_108_valid : IsValidTransition transition_108_cycle 108 := -- TODO: replace sorry
...
def stability_108_cycle : StabilityCertificate baseVerified :=
  {
    ...
    ace_bound := 6/10,
    r_bound := {r1 := 9/10, r3 := 5/10, h_r1 := -- TODO: replace sorry, h_r3 := -- TODO: replace sorry},
    is_contractive := -- TODO: replace sorry,
    is_ace_dominant := trivial
  }

end Multiplicity.Core.MOC
