...
/-!
# Foundations.MetaRelativity.Core — Five-Gate Validation Hierarchy

Formalizes the Sedona Spine compliant discrete integer arithmetic for the five validation gates.
