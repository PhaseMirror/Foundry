...
-- TODO: replace sorry-gated axioms for the PDE derivative (∂u/∂t) and tensor convergence,
then provides a fully computable finite-dimensional instantiation over Rat.

Pure core Lean 4 + std4. At most 2 -- TODO: replace sorry'd axioms (PDE derivative, tensor
...
/-- Axiom 1: Time derivative well-definedness.
    ...
    Status: -- TODO: replace sorry-gated until Mathlib integration for `InnerProductSpace`
...
/-- Axiom 2: Tensor sum convergence.
    ...
    Status: -- TODO: replace sorry-gated until Mathlib integration for `Summable` or
