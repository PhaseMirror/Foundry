...
/-!
# Foundations.PdeRnn.Spec — Axiom-Clean PDE-RNN Stability & Contraction

Abstracts PDE-RNN dynamics to verified bounded spectral norms and Lipschitz contraction.
Zero axioms, zero sorry, zero Mathlib.
-/
