...
Shared prime number definitions and predicates used across all formalizations.
This module provides computable, axiom-clean definitions for primality testing,
factorization, and divisor structures.

All definitions are 100% computable, zero-Mathlib, zero-axiom, zero-sorry.
-/

namespace Foundations.Prime
