...
/-
F1 square — the constructive complex number interface, re-exported from the
...
export UOR.Bridge.F1Square.Analysis (Complex Ceq Cadd Cneg Cmul ofReal Czero Cone I CnormSq)
