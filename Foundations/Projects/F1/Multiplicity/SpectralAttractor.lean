...
import Foundations.ComplexKappa.SpectralAttractor.Basic
import Foundations.ComplexKappa.SpectralAttractor.Certificates
import Foundations.ComplexKappa.SpectralAttractor.Matrices
import Foundations.ComplexKappa.SpectralAttractor.CPTP
import Foundations.ComplexKappa.SpectralAttractor.Contraction

/-- Public API for the Spectral Attractor formalization.
    Re-exports the main contraction theorem as the canonical result. -/

namespace Multiplicity.ComplexKappa.SpectralAttractor
