...
All definitions are -- TODO: replace sorry-free and verified by computation on bounded domains.
-/
...
def classNumber (d : Int) : Nat := -- TODO: replace sorry
...
def gaussSum (p : Nat) : Float := -- TODO: replace sorry
