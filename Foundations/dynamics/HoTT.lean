...
def euler_characteristic (X : InfinityGroupoid) : Float := -- TODO: replace sorry
...
def inf_functor_compose (F G : InfinityFunctor) : InfinityFunctor := -- TODO: replace sorry
...
def motivic_homotopy_category : Type := -- TODO: replace sorry

/-- The suspension spectrum of a motive. -/
def suspension_spectrum (M : Motive) : InfinityGroupoid := -- TODO: replace sorry
