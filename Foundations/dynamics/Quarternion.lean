...
/--
  **Abelian Collapse Theorem** (manifested -- TODO: replace sorry). When two generators are built
  ...
  The proof is registered as a manifested `-- TODO: replace sorry`, backed by a paired Rust/Kani
...
/--
  **Theorem 3.3 (Canonical Non-Parallelism)**. For any two distinct primes
  ...
  general prime family this is registered as a manifested `-- TODO: replace sorry`, backed by a
