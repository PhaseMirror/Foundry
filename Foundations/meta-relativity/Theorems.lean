...
All proofs are pure propositional logic over Nat inequalities — no axioms, no -- TODO: replace sorry.
-/

namespace Multiplicity.META_RELATIVITY
...
end Multiplicity.META_RELATIVITY
