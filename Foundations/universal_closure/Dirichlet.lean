...
-- ===========================================================================
-- Involution: Nat-arithmetic -- TODO: replace sorry's (standard division facts)
-- ===========================================================================
...
/-- Dirichlet convolution is commutative.
    ...
    **Proof architecture.**  Define the modified divisor involution
    ...
    The four Nat-arithmetic -- TODO: replace sorry's are standard number-theory facts
...
/-- Dirichlet inversion: `μ * 1 = ε`.
    ...
    lattice.  Discharged with `-- TODO: replace sorry` pending evaluation infrastructure
