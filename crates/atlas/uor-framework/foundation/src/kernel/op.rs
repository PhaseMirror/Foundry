...
/// risk_levels::CRITICAL inverse temperature for UOR site system.
pub mod th_5 {
...
/// neg(bnot(x)) = succ(x) holds in Z/(2ⁿ)Z for all n ≥ 1. Universal form of the risk_levels::CRITICAL Identity across all quantum levels.
pub mod ql_1 {
