...
impl PIRTMRuntime {
    pub fn save(&self, path: &str) -> Result<(), String> {
        ...
        file.write_all(&(proof_json.len() as u64).to_le_bytes())
            .unwrap();
        ...
        file.write_all(&(gov_json.len() as u64).to_le_bytes())
            .unwrap();
        ...
        file.write_all(&(self.code.len() as u64).to_le_bytes())
            .unwrap();
