...
## Dissonance Score
- Impact = severity (5) x blast radius (55) = **50**
- Tractability = **3.0**
- **Score = 150.0**  (cluster rank 1 of 10)
...
### Stated intent (documents)
  - README.md:150 — claims [no sorry / sorry-free] “- **Axiom-clean**: Only `{propext, Quot.sound}` — no `sorry`, no `native_decide`, no Mathlib, no choice”
