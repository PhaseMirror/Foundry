# ADR-PML-003: Documented physical/mathematical invariants asserted as guaranteed but risk not owned
...
- Tractability = **3.0**
- **Score = 72.0**  (cluster rank 3 of 10)
...
### Stated intent (documents)
  ...
  - docs/adr/completed/ADR-PML-011.md:24 — - docs/PIRTM_SPEC.md:166 — 2. **Runtime checks** in the WardMonitor (ρ drift threshold). Telemetry tests enforce `ANOMAL
