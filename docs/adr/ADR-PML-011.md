# ADR-PML-011: Formal-verification purity claims contradict the UAC-ALP boundary reality
...
### Implementation reality (lean/)
  ...
  - manifest permits 25 sorry(s) not present in current lean: Core.F1.Analysis.CosSinAddFormula.antidiagonal_convergence, Core.F1.Analysis.GammaOne.gamma1_rational_bound, Core.F1.Analysis.GammaTwo.cApprox_le_bound, Core.F1.Analysis.GammaTwo.gamma2_convergence, Core.F1.Analysis.GammaTwo.gamma2_monotone ...
