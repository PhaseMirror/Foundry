# ADR-PML-012: alp_sorry_manifest.json permits sorrys that are absent from the current lean tree (stale boundary)
...
## Dissonance Score
- Impact = severity (3) x blast radius (25) = **30**
- Tractability = **5.0**
...
### Stated intent (documents)
  - alp_sorry_manifest.json permits 25 sorry(s) not present in lean

### Implementation reality (lean/)
  - stale permitted sorrys: Core.F1.Analysis.CosSinAddFormula.antidiagonal_convergence, Core.F1.Analysis.GammaOne.gamma1_rational_bound, Core.F1.Analysis.GammaTwo.cApprox_le_bound, Core.F1.Analysis.GammaTwo.gamma2_convergence, Core.F1.Analysis.GammaTwo.gamma2_monotone, Core.F1.Analysis.GammaTwo.gamma2_term_bound ...
