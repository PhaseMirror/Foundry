# ADR-PML-015: Declared control surfaces (circuit-breaker / veto / triple-lock) not provably wired to enforcement
...
- Tractability = **1.0**
- **Score = 24.0**  (cluster rank 5 of 11)
...
### Stated intent (documents)
  ...
  - docs/adr/completed/ADR-062-SigmaKernel-Production-Implementation.md
  - docs/adr/completed/ADR-063-StratifiedGovernance-Production-Implementation.md
  - docs/adr/completed/ADR-065-ACE-Runtime-Production-Hardening.md
