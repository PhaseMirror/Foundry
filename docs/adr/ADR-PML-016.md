# ADR-PML-016: Documented Lean theorems missing in the `general` subsystem (48 gaps)
...
### Implementation reality (lean/)
  - `successor_contractivity_correct` not found among 8183 lean declarations
  - `ace_preserves_invariants` not found among 8183 lean declarations
  - `budget_exhaustion_detected` not found among 8183 lean declarations
  - `global_contraction_margin` not found among 8183 lean declarations
