# ADR-PML-022: Formal-verification purity claims contradict the UAC-ALP boundary reality
...
- Tractability = **4.0**
- **Score = 200.0**  (cluster rank 1 of 11)
...
### Implementation reality (lean/)
  ...
  - manifest permits 1 sorry(s) not present in current lean: sq_nonneg_int
