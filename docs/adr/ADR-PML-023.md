# ADR-PML-023: Documented Lean theorems missing in the `governance` subsystem (7 gaps)
...
### Implementation reality (lean/)
  - `semantic_trace_unique` not found among 8183 lean declarations
  - `FockTrunc` not found among 8183 lean declarations
  - `liftOperator` not found among 8183 lean declarations
  - `uniform_boundedness` not found among 8183 lean declarations
