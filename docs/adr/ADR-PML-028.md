# ADR-PML-028: alp_sorry_manifest.json permits sorrys that are absent from the current lean tree (stale boundary)
...
- Tractability = **5.0**
- **Score = 15.0**  (cluster rank 7 of 11)
...
### Implementation reality (lean/)
  - stale permitted sorrys: sq_nonneg_int
