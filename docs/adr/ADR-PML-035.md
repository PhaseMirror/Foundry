# ADR-PML-035: Documented physical/mathematical invariants asserted as guaranteed but risk not owned
...
## Dissonance Score
- Impact = severity (4) x blast radius (9) = **36**
- Tractability = **3.0**
- **Score = 108.0**  (cluster rank 3 of 11)
