# ADR-PML-047: alp_sorry_manifest.json permits sorrys that are absent from the current lean tree (stale boundary)
...
## Dissonance Score
- Impact = severity (3) x blast radius (4) = **12**
- Tractability = **5.0**
- **Score = 60.0**  (cluster rank 4 of 11)
...
### Stated intent (documents)
  - alp_sorry_manifest.json permits 4 sorry(s) not present in lean

### Implementation reality (lean/)
  - stale permitted sorrys: corrTP1_le_teldiff1, corrTP_le_corrT, corrT_le_teldiff, sq_nonneg_int
