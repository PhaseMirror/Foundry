...
theorem tpair1_HV (q d t : Int) : tpair1 q d t (1, 0, 0, 0) (0, 1, 0, 0) = 1 := by decide
theorem tpair1_HH (q d t : Int) : tpair1 q d t (1, 0, 0, 0) (1, 0, 0, 0) = 0 := by decide
theorem tpair1_VV (q d t : Int) : tpair1 q d t (0, 1, 0, 0) (0, 1, 0, 0) = 0 := by decide
theorem tpair1_HD (q d t : Int) : tpair1 q d t (1, 0, 0, 0) (0, 0, 1, 0) = 1 := by decide
theorem tpair1_VD (q d t : Int) : tpair1 q d t (0, 1, 0, 0) (0, 0, 1, 0) = 1 := by decide
theorem tpair1_DD (q d t : Int) : tpair1 q d t (0, 0, 1, 0) (0, 0, 1, 0) = d := by decide
theorem tpair1_HG (q d t : Int) : tpair1 q d t (1, 0, 0, 0) (0, 0, 0, 1) = 1 := by decide
theorem tpair1_VG (q d t : Int) : tpair1 q d t (0, 1, 0, 0) (0, 0, 0, 1) = q := by decide
theorem tpair1_DG (q d t : Int) : tpair1 q d t (0, 0, 1, 0) (0, 0, 0, 1) = t := by decide
theorem tpair1_GG (q d t : Int) : tpair1 q d t (0, 0, 0, 1) (0, 0, 0, 1) = 0 := by decide

/- The ample class for a single prime: H = H + V. -/
def tample1 (q d t : Int) : T1Cls := (1, 1, 0, 0)

/- H² = 2 > 0 for the single-prime template. -/
theorem tample1_sq_pos (q d t : Int) : 0 < tpair1 q d t (tample1 q d t) (tample1 q d t) := by decide
...
theorem t1_hodge_iff_hasse (q a d t : Int) (h_t : t = q + 1 - a) :
  ...
  · intro h
    have h2 := h a (-2)
    rw [tprimDG_sq q a d t x y h_t] at h2
...
theorem multiPrime_block_signature (n : Nat) (q a : Fin n → Int) (d t : Fin n → Int)
  ...
  fun i x y => (t1_hodge_iff_hasse (q i) (a i) (d i) (t i) (h_t i)).mpr (h_hasse i)
