import Core.foundations.BanachSpace
...
theorem pirtm_to_langlands_stability
  ...
  refine ⟨(⟨spectral_radius / (1 - ε), 0⟩ : ℂ), ?_⟩
  unfold satake_bridge_compliant ramanujan_bound
  simp
  apply div_pos_iff.2 ⟨h_stable, by linarith⟩
  apply pow_pos _ 2
  linarith
