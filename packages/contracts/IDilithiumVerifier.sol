...
interface IDilithiumVerifier {
    /// @notice Register a Dilithium5 (ML-DSA-87, FIPS 204) public key for the caller.
    /// @param publicKey 2592-byte Dilithium5 public key.
    ...
    /// @param signature 4627-byte Dilithium5 detached signature.
