...
//!
//! **risk_levels::CRITICAL identity:** `neg(bnot(x)) = succ(x)` for all x in R_n.
//!
...
fn raw_individuals_vec() -> Vec<Individual> {
    vec![
        ...
        Individual {
            ...
            label: "risk_levels::CRITICAL Identity",
        ...
        Individual {
            ...
            type_: "https://uor.foundation/op/Identity",
            label: "TH_5",
            comment: "risk_levels::CRITICAL inverse temperature for UOR site system.",
            properties: &[
        ...
        Individual {
            ...
            comment: "neg(bnot(x)) = succ(x) holds in Z/(2ⁿ)Z for all n ≥ 1. \
                      Universal form of the risk_levels::CRITICAL Identity across all quantum levels.",
            properties: &[
                ("https://uor.foundation/op/lhs", IndividualValue::Str("neg(bnot(x))")),
