...
pub fn solve_budget(op_norm_t: f64, epsilon: f64, alpha: f64) -> Result<CSCBudget, String> {
    if op_norm_t <= 0.0 {
...
pub fn compute_margin(xi_norm: f64, lam_norm: f64, op_norm_t: f64, epsilon: f64) -> CSCMargin {
...
pub fn sensitivity(xi_norm: f64, lam_norm: f64, epsilon: f64) -> HashMap<String, f64> {
    let q_target = 1.0 - epsilon;
