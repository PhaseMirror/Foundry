...
**Implementation Note:** The normative schema below is implemented as the authoritative governance interface in the `knot-in-time-core` Rust crate. The `ConstitutionalRuntime` module dynamically enforces these parameters.
