...
\begin{enumerate}
    \item \textbf{RT-001 (Ractor):} Fault containment at the L0 runtime level, verified by simulating tool broker panics and asserting native ACE certificates and triple lock governance rollback.
    ...
    \item \textbf{$\perp_R(E)$ (Langlands Registrar):} Constitutional reject; all failures are logged to native ACE certificates and triple lock governance and cannot be overridden.
\end{enumerate}
